...
import com.ralphmarondev.keepsafe.core.presentation.components.EmailField
            ...
            item {
                OutlinedCard(
                    ...
                    Column(
                        ...
                        EmailField(
                            email = state.email,
                            onEmailChange = { action(LoginAction.EmailChange(it)) },
                            modifier = Modifier
                                .fillMaxWidth(),
                            keyboardOptions = KeyboardOptions(
                                imeAction = ImeAction.Next
                        ...
                        PasswordField(
                            ...
                            onPasswordChange = { action(LoginAction.PasswordChange(it)) },
                            modifier = Modifier
                                .fillMaxWidth(),
                            keyboardOptions = KeyboardOptions(
